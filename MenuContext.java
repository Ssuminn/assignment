...
class MenuContext {
    private Map<String, List<Menu>> menus;	// 메뉴 리스트
    private Map<String, List<Item>> menuItems;	// 상품메뉴 리스트
    private List<Item> cart;	// 장바구니 리스트
    ...
    private void initializeMenuItems() {
        ...
        menus.put("Main", mainMenus); //Main을 조회(.get를 하면 mainMenus List에 .add된 값이 나옴
